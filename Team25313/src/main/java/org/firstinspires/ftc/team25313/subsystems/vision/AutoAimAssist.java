...
//
//    public AutoAimAssist(LinearOpMode opMode, DriveSubsystem driveSubsystem, DetectArtifactProcessor vision) {
//        super(opMode);
...
//                driveSubsystem.setDrivePower(-turnPower, turnPower, -turnPower, turnPower);
//            } else {
//                driveSubsystem.stop();
//            }
//
