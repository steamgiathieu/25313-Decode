...
public final class Constants {
    ...
    public static final double intakeMotorIn = 0.55;
    public static double intakeMotorShoot = 0.32;
    public static final double farZoneIntakeMotorShoot = 0.32;
    public static final double closeZoneIntakeMotorShoot = 0.4;
    ...
    public static double adaptive_launcherF = 11.8;
    public static final double launcherF_high = 11.2; //at 14V
    public static final double launcherF_low = 12.5; //at 11V
