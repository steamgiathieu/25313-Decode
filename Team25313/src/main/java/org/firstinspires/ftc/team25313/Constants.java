...
public final class Constants {
    ...
    public static double intakeMotorShoot = 0.35;
    public static final double farZoneIntakeMotorShoot = 0.35;
    public static final double closeZoneIntakeMotorShoot = 0.45;
